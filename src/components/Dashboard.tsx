              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-3 md:p-4 flex items-center gap-2 md:gap-4 group hover:border-slate-500 transition-colors">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="text-[9px] md:text-xs text-slate-400 uppercase font-bold tracking-wider truncate">Рейтинг</div>
                    <div className={`text-sm sm:text-base md:text-xl font-black leading-tight break-words ${isUnranked ? 'text-yellow-400' : pvpRank?.color}`}>
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-3 md:p-4 flex items-center gap-2 md:gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="text-[9px] md:text-xs text-slate-400 uppercase font-bold tracking-wider truncate">{t('dashboard.solved')}</div>
                    <div className="text-lg sm:text-xl md:text-2xl font-black text-white">{profile.total_experiments}</div>
                  </div>
                </div>
                ...
                <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-3 md:p-4 flex items-center gap-2 md:gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="text-[9px] md:text-xs text-slate-400 uppercase font-bold tracking-wider truncate">{t('dashboard.accuracy')}</div>
                    <div className="text-lg sm:text-xl md:text-2xl font-black text-white">{profile.success_rate.toFixed(0)}%</div>
                  </div>
                </div>
              </div>
