      ...
      >
        ...
        <div className="relative bg-slate-900 border-2 rounded-3xl overflow-hidden shadow-2xl" style={{ borderColor: newRank.gradientFrom }}>
          ...
          <div className="relative p-8 text-center space-y-6">
            ...
            <button onClick={handleClose} className="w-full mt-6 py-4 rounded-xl font-bold text-white transition-all hover:scale-105 active:scale-95 shadow-lg" style={{ background: `linear-gradient(135deg, ${newRank.gradientFrom}, ${newRank.gradientTo})` }}>Продолжить</button>
