          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between gap-4">
            ...
            <button onClick={handleBackToMap} className="flex items-center gap-3 hover:opacity-80 transition-opacity group min-w-fit">
              ...
              <img 
                 src="/logo.png" 
                 alt="Logo" 
                 className="w-10 h-10 rounded-xl object-cover border border-cyan-500/30 shadow-lg shadow-cyan-500/20 group-hover:scale-105 transition-transform"
                 onError={(e) => { 
                    e.currentTarget.style.display='none'; 
                    // Если лого нет - показываем запасную иконку
                    e.currentTarget.parentElement?.insertAdjacentHTML('beforeend', '<div class="p-2 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-lg"><svg class="w-6 h-6 text-white" ...></svg></div>'); 
                 }}
              />
