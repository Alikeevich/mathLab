  ...
  ru: {
    translation: {
      ...
      faq: {
        ...
        q1: "Как повысить рейтинг (MP)?",
        a1: "Играйте в PvP-режиме. За победу вы получаете от 20 до 50 очков, за поражение теряете 10-30. Серия побед дает бонус.",
        q2: "Что дает Сурикат?",
        a2: "Сурикат — ваш помощник. Если он сыт, он может давать подсказки в сложных задачах. Не забывайте кормить его!",
        q3: "Как получить Premium?",
        a3: "Нажмите на кнопку 'Тарифы' в меню. Premium удваивает опыт (XP), открывает журнал ошибок и дает доступ к расширенной статистике.",
        q4: "Я нашел ошибку в задаче",
        a4: "Напишите нам на support@mathlabpvp.org или используйте кнопку 'Пожаловаться' после матча.",
        q5: "Как создать турнир?",
        a5: "Создание турниров доступно только пользователям со статусом 'Учитель' (Teacher)."
      },
      legal_links: {
  ...
  kk: {
    ...
    pricing: {
      ...
      faq: {
        ...
        q1: "Рейтингті (MP) қалай көтеруге болады?",
        a1: "PvP режимінде ойнаңыз. Жеңіс үшін 20-50 ұпай аласыз, жеңіліс үшін 10-30 жоғалтасыз. Жеңістер сериясы бонус береді.",
        q2: "Сурикат не үшін керек?",
        a2: "Сурикат — сіздің көмекшіңіз. Егер ол тоқ болса, қиын есептерде кеңес бере алады. Оны тамақтандыруды ұмытпаңыз!",
        q3: "Premium қалай алуға болады?",
        a3: "Мәзірдегі 'Тарифтер' түймесін басыңыз. Premium тәжірибені (XP) екі еселейді, қателер журналын ашады және толық статистиканы береді.",
        q4: "Есепте қате таптым",
        a4: "Бізге support@mathlabpvp.org мекенжайына жазыңыз немесе матчтан кейін 'Шағымдану' түймесін қолданыңыз.",
        q5: "Турнирді қалай құруға болады?",
        a5: "Турнирлерді құру тек 'Мұғалім' (Teacher) мәртебесі бар қолданушыларға қолжетімді."
      },
      legal_links: {
        privacy: "Құпиялылық",
