...
const resources = {
  ru: {
    translation: {
      ...
      pricing: {
        ...
        plan_b2b_title: "Школам и Центрам",
        plan_b2b_subtitle: "Enterprise / B2B",
        plan_b2b_desc: "Внедрите MathLab PvP в учебный процесс всей школы. Глобальная аналитика, безлимитные аккаунты для учителей и учеников, а также брендирование.",
        btn_contact_sales: "Оставить заявку",
        feat_b2b_1: "Глобальная аналитика по всем классам",
        feat_b2b_2: "Выгрузка отчетов для ЕНТ",
        feat_b2b_3: "Единая подписка на всю школу",
        feat_b2b_4: "Личный менеджер поддержки"
      },
      dashboard: {
        title: "Личное Дело",
        level: "Уровень",
  ...
  kk: {
    ...
    pricing: {
        ...
        plan_b2b_title: "Мектептер мен Орталықтарға",
        plan_b2b_subtitle: "Enterprise / B2B",
        plan_b2b_desc: "MathLab PvP-ді бүкіл мектептің оқу процесіне енгізіңіз. Жаһандық аналитика, мұғалімдер мен оқушыларға шексіз аккаунттар және брендинг.",
        btn_contact_sales: "Өтінім қалдыру",
        feat_b2b_1: "Барлық сыныптар бойынша жаһандық аналитика",
        feat_b2b_2: "ҰБТ үшін есептерді жүктеп алу",
        feat_b2b_3: "Бүкіл мектепке ортақ жазылым",
        feat_b2b_4: "Жеке қолдау менеджері",
